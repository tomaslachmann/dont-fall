...
const ROWS: TrackListing[] = [
  { id: "t1", name: "Wobble Ramp", authorId: "a1", createdAt: 1_000, revision: 1, plays: 12, playsThisWeek: 12, playsToday: 0, hasFinishZone: true, hasThumbnail: false },
  { id: "t2", name: "Arena Bowl", authorId: "a1", createdAt: 2_000, revision: 1, plays: 3, playsThisWeek: 3, playsToday: 0, hasFinishZone: false, hasThumbnail: false },
];
