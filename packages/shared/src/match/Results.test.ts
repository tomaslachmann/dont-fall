...
describe("buildResults", () => {
  it("ranks Qualified Characters by finish Tick, earliest first", () => {
    const rows = buildResults(
      ...
      [
        { id: "a", nickname: "Alice", ready: true, joinOrder: 0, accountId: null, bodySkin: null, hat: null },
        { id: "b", nickname: "Bob", ready: true, joinOrder: 1, accountId: null, bodySkin: null, hat: null },
      ],
      [],
    );
  ...
  it("appends a DNF row for a Player who dropped mid-Round, last and unranked", () => {
    const rows = buildResults(
      { a: { finishTick: 100, checkpointIndex: 4, fallCount: 0 } },
      [{ id: "a", nickname: "Alice", ready: true, joinOrder: 0, accountId: null, bodySkin: null, hat: null }],
      [{ id: "left-id", nickname: "Casey", accountId: null, bodySkin: null, hat: null }],
    );
